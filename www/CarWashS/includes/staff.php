  ...
  <main class="main-content">
    <div class="dashboard-header">
      <div class="header-content">
        ...
        <p class="header-subtitle">Manage team members and their schedules</p>
      </div>
    ...
    <div class="container">
      <section class="panel form-card">
        <h2>New Staff</h2>
        <p class="muted">Add a new team member to the system.</p>
      ...
      <section class="panel table-card">
        <div class="table-header">
          ...
          <div class="table-actions">
            <input id="tableSearch" type="search" placeholder="Search staff...">
          </div>
        </div>
